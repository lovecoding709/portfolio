...
export function Hero() {
  ...
  return (
    <section
      id="hero"
      className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-neutral-50 to-neutral-100"
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Web3 Designer & SaaS Developer specializing in decentralized
            applications and scalable cloud solutions. Creating innovative
            blockchain experiences and enterprise software with elegant design
